      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">2. Quotes and Pricing</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">4. Scheduling and Cancellations</h2>
            <ul className="list-disc pl-6 text-muted-foreground mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">6. Workmanship and Warranty</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">8. Property Damage</h2>
            <p className="text-muted-foreground mb-6">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">9. Termination</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">10. Dispute Resolution</h2>
            <p className="text-muted-foreground mb-6">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">11. Website Use</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">12. Changes to Terms</h2>
            <p className="text-muted-foreground mb-6">
